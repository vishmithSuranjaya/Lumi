...
function SignInContent() {
    ...
    // Map query parameter errors to user-friendly messages
    useEffect(() => {
        if (errorParam === "google_not_configured") {
            setErrorMessage(
                "Google OAuth is not configured yet. Please provide GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in .env.local."
            );
        } else if (errorParam === "auth_required") {
            setErrorMessage("Please sign in to access this area.");
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="mt-2 text-sm text-neutral-500">
                            Sign in to manage your vehicle listings, inquiries & account
                        </p>
                    </div>
